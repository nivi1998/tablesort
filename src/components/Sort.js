...
// function createData(Player, Age, Country, Position, Team) {
//   return { Player, Age, Country, Position, Team };
// }
...
// //       const newSelecteds = data.map((n) => n.Player);
...
//                 .map((data, index) => {
//                   const isItemSelected = isSelected(data.Player);
...
//                         {data.name}
//                       </TableCell> */}
//                       <TableCell align="right">{data.Player}</TableCell>
...
// export default function onChange(sorter, extra) {
